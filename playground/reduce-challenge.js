...
Metadata
Last modified: Nov 28, 2020, by MDN contributors
Related Topics
...
Cookies`
 ...
 function isValidChar(char) {
    // if that character is a-z A-Z 0-9 then we want to keep it 
...
//  };
 ...
 // same lowercase function but in arrow
...
const result = text
.split('') // split each item into an item of an array
.filter(isValidChar)
